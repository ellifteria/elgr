class GroundPlane {
    public sinIterations: number;
    public numXLines: number;
    public numYLines: number;
    ...
    constructor(sinIterations: number = 7, numXLines: number = 50, numYLines: number = numXLines, frequency: number = 0.025, floatsPerVertex: number = 7, worldSize: number = 250, height: number = 1) {
    ...
    calculateHeightAtPoint(x: number, y: number) {
        let result = 0;
